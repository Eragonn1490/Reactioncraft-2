...
public class CurrencyArmor2 extends ItemArmor
{
	...
	public CurrencyArmor2(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
	...
	{
		if ((itemstack.itemID == IntegratedItems.rubycrown.itemID || (itemstack.itemID == IntegratedItems.KinglyChest.itemID || itemstack.itemID == IntegratedItems.KinglyBoots.itemID)))
			return "reactioncraft:textures/models/rubycrown_1.png";
	...
	{
		if(itemID == IntegratedItems.rubycrown.itemID)
			this.itemIcon = par1IconRegister.registerIcon("reactioncraft:rubycrown");
		this.canRepair = true;
