...
public class CurrencyArmor5 extends ItemArmor
{
	...
	public CurrencyArmor5(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
	...
	{
		if ((itemstack.itemID == IntegratedItems.emeraldcrown.itemID || (itemstack.itemID == IntegratedItems.KinglyChest.itemID || itemstack.itemID == IntegratedItems.KinglyBoots.itemID)))
			return "reactioncraft:textures/models/emeraldcrown_1.png";
	...
	{
		if(itemID == IntegratedItems.emeraldcrown.itemID)
			this.itemIcon = par1IconRegister.registerIcon("reactioncraft:emeraldcrown");
		this.canRepair = true;
