...
public class SurfaceWorldGenerator implements IWorldGenerator
{
  ...
  public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
  {
    if (this.apatiteGenerator == null) 
    {
      ...
      this.tinGenerator       = new WorldGenMinableMeta(IntegratedBlocks.surfaceOres.blockID, 0, 6);
      this.ventiniteGenerator = new WorldGenMinableMeta(IntegratedBlocks.surfaceOres.blockID, 1, 1);
    }
...
//    }
    ...
    if (IntegratedProperties.genSilver.getBoolean(true)) {
      for (int i = 0; i < 16; i++) {
        int randPosX = chunkX + random.nextInt(16);
