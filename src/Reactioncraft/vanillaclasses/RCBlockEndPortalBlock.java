...
public class RCBlockEndPortalBlock extends BlockEndPortal
{
    /**
    ...
    public RCBlockEndPortalBlock(int par1, Material par2Material)
    {
    ...
    {
    	if (par1World.getBlockId(x + 1, y, z) != this.blockID || par1World.getBlockId(x - 1, y, z) != this.blockID || par1World.getBlockId(x, y, z + 1) != this.blockID || par1World.getBlockId(x, y, z - 1) != this.blockID || par1World.getBlockId(x + 1, y, z) != IntegratedBlocks.enderportal.blockID || par1World.getBlockId(x - 1, y, z) != IntegratedBlocks.enderportal.blockID || par1World.getBlockId(x, y, z + 1) != IntegratedBlocks.enderportal.blockID || par1World.getBlockId(x, y, z - 1) != IntegratedBlocks.enderportal.blockID)
        {
