...
public abstract class EntityPlayer2 extends EntityPlayer implements ICommandSender
{
     ...
     */
    public EntityReactionFishHook fishEntity = null;

    public EntityPlayer2(World par1World)
    {
        super(par1World);
    ...
    public void addToPlayerScore(Entity par1Entity, int par2)
    {
        ...
        if (par1Entity instanceof EntityPlayer2)
        {
    ...
    public boolean func_96122_a(EntityPlayer2 par1EntityPlayer)
    {
    ...
    protected void alertWolves(EntityLiving par1EntityLiving, boolean par2)
    {
        if (!(par1EntityLiving instanceof EntityCreeper) && !(par1EntityLiving instanceof EntityGhast))
        {
            ...
            if (!(par1EntityLiving instanceof EntityPlayer2) || this.func_96122_a((EntityPlayer2)par1EntityLiving))
            {
     ...
     */
    protected int getExperiencePoints(EntityPlayer2 par1EntityPlayer)
    {
        if (this.worldObj.getGameRules().getGameRuleBooleanValue("keepInventory"))
        {
            return 0;
     ...
     * Inventory.
     */
    public void clonePlayer(EntityPlayer2 par1EntityPlayer, boolean par2)
    {
        if (par2)
        {
    ...
    @SideOnly(Side.CLIENT)
    public boolean func_98034_c(EntityPlayer2 par1EntityPlayer)
    {
        if (!this.isInvisible())
        {
            return false;
