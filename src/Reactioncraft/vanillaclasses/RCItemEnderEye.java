...
public class RCItemEnderEye extends ItemEnderEye
{
    public RCItemEnderEye(int par1)
    {
        super(par1);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) && i1 == IntegratedBlocks.enderportal.blockID && !BlockEndPortalFrame.isEnderEyeInserted(j1))
        {
            ...
            else
            {
                ...
                par3World.func_96440_m(par4, par5, par6, IntegratedBlocks.enderportal.blockID);
                ...
                for (k2 = -2; k2 <= 2; ++k2)
                {
                    ...
                    if (k3 == IntegratedBlocks.enderportal.blockID)
                    {
                ...
                if (flag1 && i2 == l1 + 2)
                {
                    for (k2 = l1; k2 <= i2; ++k2)
                    {
                        ...
                        if (k3 != IntegratedBlocks.enderportal.blockID || !BlockEndPortalFrame.isEnderEyeInserted(i3))
                        {
                            flag1 = false;
                            break;
                        }
                    ...
                    for (k2 = l1 - 1; k2 <= i2 + 1; k2 += 4)
                    {
                        for (j3 = 1; j3 <= 3; ++j3)
                        {
                            ...
                            if (i3 != IntegratedBlocks.enderportal.blockID || !BlockEndPortalFrame.isEnderEyeInserted(l3))
                            {
                                flag1 = false;
                                break;
                            }
                    ...
                    if (flag1)
                    {
                        for (k2 = l1; k2 <= i2; ++k2)
                        {
                            for (j3 = 1; j3 <= 3; ++j3)
                            {
                                ...
                                l2 += Direction.offsetX[k1] * j3;
                                k3 += Direction.offsetZ[k1] * j3;
                                par3World.setBlock(l2, par5, k3, IntegratedBlocks.enderportalp.blockID, 0, 2);
                            }
                        }
                    }
                }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (movingobjectposition != null && movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (i == IntegratedBlocks.enderportal.blockID)
            {
