...
public class Integration 
{
	...
	public static void loadRailCraft() 
	{
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(IntegratedItems.Blackdiamondbore, true, new Object[]{"XXX", "X#X", "XXX", Character.valueOf('X'), "ingotSteel", Character.valueOf('#'), "diamondBlack"}));
	}
	...
	public static void loadIndustrialCraft() 
	{
		...
		Recipes.macerator.addRecipe(new RecipeInputOreDict("oreBloodstone", 1), null, new ItemStack[] { new ItemStack(IntegratedItems.bloodstonedust, 4)});

		//Black Diamond Ore to Black Diamond
		Recipes.macerator.addRecipe(new RecipeInputOreDict("oreNetherBlackDiamond", 1), null, new ItemStack[] { new ItemStack(IntegratedItems.blackdiamond, 1)});
