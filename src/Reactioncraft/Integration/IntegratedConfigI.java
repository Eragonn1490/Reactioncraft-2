...
public class IntegratedConfigI 
{
	...
	public static int rubyIID;
	//Crowns
	public static int rubycrownIID;
	public static int diamondcrownIID;
	public static int emeraldcrownIID;
	//Bloodstone
	public static int bloodstonehelmIID;
	public static int bloodstonechestIID;
	public static int bloodstonelegsIID;
	public static int bloodstonebootsIID;
	...
	public static int completeNetIID;
	public static int creativeNetIID;
