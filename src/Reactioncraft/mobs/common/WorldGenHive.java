...
public WorldGenHive(boolean par1)
{
         this(par1, 4, 0, 0, false);
}
public WorldGenHive(boolean par1, int par2, int par3, int par4, boolean par5)
{
         super(par1);
                                         ...
                                         for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                                         {
                                                 ...
                                                 for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                                                 {
                                                         ...
                                                         if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                                         {
                                                                 ...
                                                                 {
                                                                         this.setBlockAndMetadata(par1World, j2, j1, l2, RCmobs.hive.blockID, this.metaLeaves);
                                                                 }
                                                         }
                                                 }
                                         }
