...
public class ItemCreativeNet extends ItemTool 
{
	public ItemCreativeNet(int par1) 
	{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) 
	{
		if (itemStack.stackTagCompound != null) 
		{
			...
			list.add("Please craft actual net this a placeholder one"); 
			list.add("for the creative tab. has 2 uses!");
