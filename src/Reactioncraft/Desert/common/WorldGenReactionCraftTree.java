...
public class WorldGenReactionCraftTree extends WorldGenerator implements IWorldGenerator
{
	...
	public WorldGenReactionCraftTree(boolean par1)
	{
		this(par1, 8, 0, 0, false);
	}
	public WorldGenReactionCraftTree(boolean par1, int par2, int par3, int par4, boolean par5)
	{
		super(par1);
			...
			IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
	{
		for(int i = 0; i < 10; i++)
		{
			...
			(new WorldGenReactionCraftTree(false, 9, 0, 0, false)).generate(world, random, xCoord, yCoord, zCoord);
		}
	}
}