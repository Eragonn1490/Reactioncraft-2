...
public class BlockCherryTreeLeaves extends BlockLeaves implements IShearable
{
    @SideOnly(Side.CLIENT)
    int[] adjacentTreeBlocks;

    public BlockCherryTreeLeaves(int par1)
    {
        super(par1);
    ...
    public int colorMultiplier(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if ((l & 3) == 1)
        {
            return ReactioncraftColorizerFoliage.getFoliageColorPine();
        }
        else if ((l & 3) == 2)
        {
            return ReactioncraftColorizerFoliage.getFoliageColorBirch();
        }
        else
        {
            int i1 = 0;
