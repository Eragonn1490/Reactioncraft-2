		...
		else if (l == 3)
		{
			for (i1 = 0; i1 >= -1; --i1)
			{
				for (j1 = 0; j1 >= -1; --j1)
				{
					...
					{
						object = new WorldGenReactionCraftTree(true, 10 + par5Random.nextInt(20), 3, 3, false);
						flag = true;
						break;
					}
				}
			...
			if (object == null)
			{
				j1 = 0;
				i1 = 0;
				object = new WorldGenReactionCraftTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
			}
		}
		else
		{
