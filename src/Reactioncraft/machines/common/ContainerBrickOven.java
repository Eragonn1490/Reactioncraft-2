...
import Reactioncraft.api.common.FreezerRecipes;
...
{
    private TileEntityBrickOven freezer;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerBrickOven(InventoryPlayer par1InventoryPlayer, TileEntityBrickOven par2TileEntityBrickOven)
    {
        this.freezer = par2TileEntityBrickOven;
        this.addSlotToContainer(new Slot(par2TileEntityBrickOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityBrickOven, 1, 56, 53));
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityBrickOven, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            {
                if (BrickOvenRecipes.smelting().getSmeltingResult(var5) != null)
                {
                ...
                else if (TileEntityBrickOven.isItemFuel(var5))
                {
