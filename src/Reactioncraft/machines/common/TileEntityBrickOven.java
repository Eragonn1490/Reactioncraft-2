...
public class TileEntityBrickOven extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Brick Oven";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockBrickOven.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = BrickOvenRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
