...
public class GuiClayalizer extends GuiContainer
{
    ...
    {
        super(new ContainerClayalizer(par1InventoryPlayer, tileEntity));
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        this.fontRenderer.drawString(StatCollector.translateToLocal("Clayalizer"), 8, this.ySize - 96 + 2, 4210752);
    }
