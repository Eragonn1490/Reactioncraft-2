...
public class ContainerFreezer extends Container
{
    ...
    public ContainerFreezer(InventoryPlayer par1InventoryPlayer, TileEntityFreezer par2TileEntityFreezer)
    {
        ...
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityFreezer, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            {
                if (FreezerRecipes.smelting().getSmeltingResult(var5) != null)
                {
