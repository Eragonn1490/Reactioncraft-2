...
public class BlockFreezer extends BlockContainer
{
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "reactioncraft:freezerfront" : "reactioncraft:freezerfrontoff");
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		if (this.isActive)
		{
			...
			if (l == 4)
			{
				par1World.spawnParticle("snowballpoof", (double)(f - f3), (double)f1, (double)(f2 + f4), 0.0D, 0.0D, 0.0D);
				par1World.spawnParticle("snowballpoof", (double)(f - f3), (double)f1, (double)(f2 + f4), 0.0D, 0.0D, 0.0D);
			}
			else if (l == 5)
			{
			...
			{
				par1World.spawnParticle("snowballpoof", (double)(f + f4), (double)f1, (double)(f2 - f3), 0.0D, 0.0D, 0.0D);
				par1World.spawnParticle("snowballpoof", (double)(f + f4), (double)f1, (double)(f2 - f3), 0.0D, 0.0D, 0.0D);
			}
			else if (l == 3)
			{
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
	{
		...
		{
			((TileEntityFreezer)par1World.getBlockTileEntity(par2, par3, par4)).func_94129_a(par6ItemStack.getDisplayName());
		}
	}
