...
public class BuilderCraftingManager
{
	...
	private BuilderCraftingManager()
	{
		...
		//this.func_92051_a(new ItemStack(MTJT.treehouseSapling, 1), new Object[] {"OOOOO", "OCOFO", " BL ", " L ", "MLLLS", Character.valueOf('O'), Block.leaves, Character.valueOf('C'), Block.chest, Character.valueOf('F'), Block.furnaceIdle, Character.valueOf('B'), Item.bed, Character.valueOf('L'), Block.wood, Character.valueOf('M'), MTJT.blackBook, Character.valueOf('S'), Block.sapling});
		//this.func_92051_a(new ItemStack(MTJT.snowmanHouse, 1), new Object[] {" O ", " #S# ", " #S# ", "#SSS#", "#SSS#", Character.valueOf('O'), Block.obsidian, Character.valueOf('#'), Item.snowball, Character.valueOf('S'), Block.snow});
