...
public class TileEntityFreezer extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Freezer";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFreezer.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FreezerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
