...
public class Block6X6 extends BlockContainer
{
	private Icon[][] iconBuffer;

	public Block6X6(int i, Material material)
	{
		super(i, material);
...
//    }
	...
	public TileEntity createNewTileEntity(World var1, int metadata) 
	{
		switch(metadata)
		{
		case 0: return new TileEntityClayalizer(); 

		case 1: return new TileEntityBrickOven();

		case 2: return new TileEntityFreezer();
		}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else
		{
			switch(metadata)
			{
			case 1:	par5EntityPlayer.openGui(RCMM.instance, 0, par1World, par2, par3, par4);

			case 0:	par5EntityPlayer.openGui(RCMM.instance, 1, par1World, par2, par3, par4);
				
			case 2: par5EntityPlayer.openGui(RCMM.instance, 2, par1World, par2, par3, par4);
			}
			return true;
		}
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		iconBuffer[0][4] = par1IconRegister.registerIcon("rcg:pinkglass"); // south
		...
		iconBuffer[1][4] = par1IconRegister.registerIcon("rcg:purpleglass"); // south
		...
		iconBuffer[2][4] = par1IconRegister.registerIcon("rcg:OrangeGlass"); // south
