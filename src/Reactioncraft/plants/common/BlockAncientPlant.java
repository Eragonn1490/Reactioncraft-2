...
public class BlockAncientPlant extends BlockFlower
{
    ...
    public BlockAncientPlant(int par1)
    {
        super(par1);
    ...
    {
        return IntegratedItems.AncientFlower.itemID;
    }
    ...
    {
        return IntegratedItems.AncientFruit.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("reactioncraft:ap_" + i);
        }
    }
}
